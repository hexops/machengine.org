    ...
    <div class="p-section always-open-source">
        <div class="transparent-card">
            ...
            <div style="text-align: left;">
                ...
                <p><a href="https://devlog.hexops.com/2021/increasing-my-contribution-to-zig-to-200-a-month#i-grew-up-playing-linux-games-like-mania-drive">FOSS is in my roots</a>: I believe we should own our tools, they should empower <em>us</em>, not playing <a href="https://kristoff.it/blog/the-open-source-game/">the open source game</a> where investors behind the scenes expect to exploit the community for multi-million dollar returns in a few years.</p>
                <p>I've had VCs urge me to take investment for my open source work, and if I wanted to get a few million to develop Mach I could do so. But I want Mach to be <a href="https://kristoff.it/blog/software-you-can-love/">Software You Can Love</a>, for people like you and me. I am <a href="https://devlog.hexops.com/2021/i-write-code-100-hours-a-week/">working double time</a> towards that goal: a simple, modest, future where I can earn a living building Mach for you, and creating high-quality games for all.</p>
