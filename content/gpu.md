...
<div class="p-section">
    ...
    <div class="p-section-right">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/advanced-gen-texture-light">advanced-gen-texture-light example</a></h2>
...
<div class="p-section">
    <div class="p-section-left">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/textured-cube">textured-cube example</a></h2>
...
<div class="p-section">
    ...
    <div class="p-section-right">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/cubemap">cubemap example</a></h2>
...
<div class="p-section">
    <div class="p-section-left">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/boids">boids example</a></h2>
...
<div class="p-section">
    ...
    <div class="p-section-right">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/image-blur">image-blur example</a></h2>
...
<div class="p-section">
    <div class="p-section-left">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/triangle">triangle example</a></h2>
...
<div class="p-section">
    ...
    <div class="p-section-right">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/rotating-cube">rotating-cube example</a></h2>
...
<div class="p-section">
    <div class="p-section-left">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/two-cubes">two-cubes example</a></h2>
...
<div class="p-section">
    ...
    <div class="p-section-right">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/instanced-cube">instanced-cube example</a></h2>
...
<div class="p-section">
    <div class="p-section-left">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/fractal-cube">fractal-cube example</a></h2>
...
<div class="p-section">
    ...
    <div class="p-section-right">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/triangle-msaa">triangle-msaa example</a></h2>
...
<div class="p-section">
    <div class="p-section-left">
        <h2><a href="https://github.com/hexops/mach-examples/tree/main/map-async">map-async example</a></h2>
